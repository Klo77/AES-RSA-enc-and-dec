...
def choice_generate_key():
    ...
    while True:
        ...
        if pub_filepath:
            ...
            break # if the user choose y then by using this break it will back the user to the menu
        else:
                            ...
                            if pub_filepath:
                                while True:
                                    ...
                                    if new_filepath:
                                        ...
                                        try:  # when the user enter an invalid file path or key file path or any thing else
                                            ...
                                            break # from the loop in line 161
                                        except:
                                ...
                                break # from the loop in line 158
                            else:
                                print(colored("Plaese enter your file name for the public key", "yellow"))
                        check = input ("Do you want another service? [y,n] ")
                        if(check == "n"):
                        ...
                        while True:
                            ...
                            if new_filepath:
                                ...
                                try:  # when the user enter an invalid file path or key file path or any thing else
                                    ...
                                    # print("CipherText: ",encrypted_message)
                                    print(colored(f"The encrypted file is saved as: {encrypted_file_path}", "green"))
                                    # break # from the loop in line 202
                                except:
                                    print(colored("Something went wrong. Please check your key and your file, and try again.", "red"))
                                    # break
                                # check = input ("Do you want another service? [y,n] ")
                            ...
                            if(check == "n"):
                                ...
                                break # from the loop in line 199
                            else:
                                print(colored("Incorrect choice. Returning to the menu.", "red"))
                                break # from the loop in line 199
                        break # from the loop in line 196
                    else:
                        print(colored("Plaese enter your file path you want to encrypt", "yellow"))
                break # from the loop in line 151
            elif key_question == "n":
        ...
        if file_path:
            while True:
                ...
                if priv_filepath:
                    while True:
                        ...
                        if new_filepath:
                            ...
                            try: # when the user enter an invalid file path or key file path or any thing else
                                ...
                                # print("Plaintext : ",decrypt_message)
                    ...
                    break # if the user choose y then by using this break ir will back the user to the menu
                else:
                    print(colored("Plaese enter your file name for the private key :)", "yellow"))
            break # if the user choose y then by using this break it will back the user to the menu
        else:
